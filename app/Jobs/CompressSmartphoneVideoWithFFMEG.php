...
class CompressSmartphoneVideoWithFFMEG implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(private array $videoPaths, private Smartphone $smartphone, private string $type) {}
    ...
    public function handle(): void
    {
        ...
        if ($this->type === 'store') {
            dispatch(new SmartphoneStoreOnAWS(['videos' => $paths], $this->smartphone));
        } elseif ($this->type === 'update') {
            dispatch(new SmartphoneUpdateOnAWS(['videos' => $paths], $this->smartphone));
        }
