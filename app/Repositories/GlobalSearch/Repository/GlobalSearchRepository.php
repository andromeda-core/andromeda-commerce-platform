                ...
                $posts = $posts->with(['floor', 'contentTranslations'])
                    ...
                    ->map(function ($post) use ($query, $isTranslatable) {
                        ...
                        return [
                            ...
                            'location_name' => $post->location_name,
                            'location_name_display' => $isTranslatable ? $post->translatedValue('location_name') : $post->location_name,
                            'latitude' => $post->latitude,
                            'longitude' => $post->longitude,
                ...
                $smartphones = $smartphones->with(['capacity', 'selling_info', 'floor', 'contentTranslations', 'model_name.contentTranslations'])
                    ...
                    ->map(function ($smartphone) use ($query, $isTranslatable) {
                        ...
                        return [
                            ...
                            'location_name_display' => $isTranslatable ? $smartphone->translatedValue('location_name') : $smartphone->location_name,
                ...
                $lodging = $lodging->with([
                    ...
                    ->map(function ($lodgingProduct) use ($query, $isTranslatable, $currencyCode) {
                        ...
                        return [
                            ...
                            'location_name_display' => $isTranslatable ? $lodgingProduct->translatedValue('location_name') : $lodgingProduct->location_name,
                ...
                if (is_array($results)) {
                    return collect($results)->map(function ($result) {
                        ...
                        return (object) [
                            ...
                            'location_name_display' => $result->location_name_display ?? $result->location_name ?? null,
