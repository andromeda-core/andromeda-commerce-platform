...
const ActivateDormantAccount = () => {
    ...
    return (
        <GuestLayout>
            ...
            <Head title={__('Deactive Dormancy', true)} />
                    ...
                    {!isSuccess ? (
                        <div className="p-8 border rounded-md border-surface-1-light dark:border-surface-1-dark bg-backgroundLight dark:bg-backgroundDark">
                            ...
                            <p className="mb-8 leading-relaxed text-center text-sub-text-light dark:text-sub-text-dark">
                                ...
                                {__('Your account has been marked as dormant due to inactivity. To continue using our services, please reactivate your account by clicking the button below.')}
                            </p>
