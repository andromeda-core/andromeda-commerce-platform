// this code uses Y axis Native And X axis Ticker But Have issues
...
//     const [xAxisLoopingRows, setXAxisLoopingRows] = useState(new Set());
//     const xRowWidthRef = useRef({});
...
//     const setHorizontalRef = useCallback((index, el) => {
...
//             //  Updating scroll position tracker
//             lastScrollTop = currentScrollTop;

//             // Debouncing to detect actual feed change
...
//                 const feedIndexReal = newIndex - 1;
...
//     const hasInitializedXAxisRef = useRef(false);

//     // X Axis SCROLL Initialize Only LOGIC
//     useEffect(() => {
//         if (!horizontalRefs.current.length) return;
//         if (!isScrollCompleted) return;

//         if (hasInitializedXAxisRef.current) return;
//         hasInitializedXAxisRef.current = true;

//         // Initialize ALL rows to index 1
//         const initializeAllRows = () => {
//             horizontalRefs.current.forEach((row, rowIndex) => {
//                 if (!row) return;

//                 const parentItem = localFeedRef.current[rowIndex];
//                 if (!parentItem) return;

//                 const related = getRelatedItems(parentItem);
...
//                 const width = firstReal.getBoundingClientRect().width;
//                 if (width > 0) {
//                     xRowWidthRef.current[rowIndex] = width;
...
//         requestAnimationFrame(initializeAllRows);
//         setTimeout(initializeAllRows, 100);
//     }, [isScrollCompleted]);
...
//                 const firstReal = children[1];
//                 if (firstReal) {
//                     if (!xRowWidthRef.current[rowIndex]) {
//                         xRowWidthRef.current[rowIndex] = firstReal.getBoundingClientRect().width;
//                     }
//                     itemWidth = xRowWidthRef.current[rowIndex];
...
//     // X axis Scroll Setting
//     useEffect(() => {
//         if (!feedIndex || feedIndex < 0) return;
//         const resetXPosition = () => {
//             const row = horizontalRefs.current[feedIndex];
//             if (!row) return;

//             const parentItem = localFeedRef.current[feedIndex];
//             if (!parentItem) return;
...
//         requestAnimationFrame(resetXPosition);
//     }, [feedIndex]);
...
//     useEffect(() => {
//         return () => {
//             hasInitializedXAxisRef.current = false;
//         };
//     }, []);
//     return (
//         <>
...
//                                         ref={(el) => setHorizontalRef(index, el)}
//                                         style={{
//                                             width: "100%",
//                                             maxWidth: "100%",
//                                             overflowY: "hidden",
