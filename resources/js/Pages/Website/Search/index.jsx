...
const index = ({
    ...
    const [defaultPostFilters, setDefaultPostFilters] = useState(filters || []);
    const [defaultFiltersCleared, setDefaultFiltersCleared] = useState(false);
    const [AllResults, setAllResults] = useState(results || []);

    const [hasSearched, setHasSearched] = useState(has_searched ?? false);
    ...
    return (
        <MainLayout>
            ...
            {hasSearched && tabResults.length > 0 && (
                <>
