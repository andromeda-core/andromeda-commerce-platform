...
const index = ({ shipping_policy, smartphone_slug }) => {
    ...
    const dynamicSections = useMemo(() => {
        return shipping_policy?.content?.map(section => ({
                    ...
                    <div className="relative overflow-hidden text-main-text-dark dark:text-main-text-light ">
                        ...
                        <div className="relative mx-auto my-10 lg:max-w-6xl sm:max-w-3xl ">
                            ...
                            <p className="max-w-3xl mt-1 text-sm text-sub-text-light dark:sub-text-dark">
                                {__('This Policy outlines international shipping terms, delivery conditions, and customer responsibilities.')}
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4 mt-5">
                                <div className="flex items-center gap-2 rounded-full bg-surface-1-light dark:bg-surface-1-dark px-3 py-1.5">
                                    ...
                                    <span className="text-sm font-medium text-sub-text-light dark:text-sub-text-dark">
                                        {__('Last Updated')}: {shipping_policy?.human_updated_at}
                                    </span>
                                </div>
                        ...
                        <main className="flex-1 space-y-6 ">
                            ...
                            <section className="p-8 rounded-md bg-surface-1-light dark:bg-surface-1-dark dark:backdrop-blur-xl">
                                <p className="leading-relaxed text-sub-text-light dark:text-sub-text-dark">
                                    {__('This Shipping Policy describes the shipping terms and conditions for products purchased from')} {shipping_policy?.company_name} {" "} ({__('“Company,” “we,” “us,” or “our”')})..
                                    {__('This policy forms part of our Terms of Service.')}
                                                    ...
                                                    >
                                                        ...
                                                        <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
                                                            <div className="px-4 py-3 break-words rounded-md bg-backgroundLight dark:bg-surface-2-dark">
                                                                ...
                                                                <p className="mt-1 text-sm font-normal text-sub-text-light dark:text-sub-text-dark">{shipping_policy?.dpo_name}</p>
                                                            </div>

                                                            <div className="px-4 py-3 break-words rounded-md bg-backgroundLight dark:bg-surface-2-dark">
                                                                <p className="text-xs font-medium text-main-text-light dark:text-main-text-dark">{__('Email Address')}</p>
                                                                <p className="mt-1 text-sm font-normal text-sub-text-light dark:text-sub-text-dark">{shipping_policy?.dpo_email}</p>
                                                            </div>


                                                            <div className="px-4 py-3 break-words rounded-md bg-backgroundLight dark:bg-surface-2-dark">
                                                                <p className="text-xs font-medium text-main-text-light dark:text-main-text-dark">{__('Phone Number')}</p>
                                                                <p className="mt-1 text-sm font-normal text-sub-text-light dark:text-sub-text-dark">{shipping_policy?.dpo_phone}</p>
                                                            </div>
                                                        ...
                                                        <div className="grid grid-cols-1 gap-3 mt-3">
                                                            <div className="px-4 py-3 break-words rounded-md bg-backgroundLight dark:bg-surface-2-dark">
                                                                ...
                                                                <p className="mt-1 text-sm font-normal text-sub-text-light dark:text-sub-text-dark">{shipping_policy?.dpo_address}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </Fragment>
