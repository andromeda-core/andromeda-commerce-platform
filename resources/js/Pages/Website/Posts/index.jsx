...
//                                         <div className="flex items-center w-full p-2 border border-gray-300 rounded-lg shadow-md focus-within:ring-2 focus-within:ring-indigo-500 dark:border-gray-700 dark:bg-gray-800 dark:shadow-white/20 dark:focus-within:ring-white/80">
//                                             <svg
//                                                 xmlns="http://www.w3.org/2000/svg"
//                                                 fill="none"
//                                                 viewBox="0 0 24 24"
//                                                 strokeWidth={1.5}
//                                                 stroke="currentColor"
//                                                 className="ml-2 text-gray-500 size-6 dark:text-gray-300"
//                                             >
//                                                 <path
//                                                     strokeLinecap="round"
...
//                                                 className="flex-1 ml-2 text-sm text-gray-700 placeholder-gray-400 bg-transparent border-none outline-none focus:outline-none focus:ring-0 dark:text-gray-200"
//                                                 value={searchQuery}
//                                                 onChange={(e) => {
...
//                                             <button
//                                                 className="p-2 mr-2 text-gray-500 rounded-full hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700"
...
//                             {windowSize.width < 1024 && (
//                                 <div className="flex items-center justify-end mx-3 my-5">
//                                     <button
//                                         className="p-2 bg-white rounded-lg hover:bg-gray-300/20 dark:bg-gray-700 dark:text-white/80"
//                                         onClick={() => setIsPostFilterSetting(true)}
//                                     >
//                                         <svg
//                                             xmlns="http://www.w3.org/2000/svg"
...
//                                                         <div className="flex items-center justify-center w-6 h-6 text-xs text-gray-900 bg-white rounded-full">
...
//                                                     __html: viewablePost?.content,
//                                                 }}
//                                                 className="text-xs prose break-words text-white/80"
//                                             ></div>
...
//                                         {/* Modal Card */}
//                                         <div className="relative z-10 w-full max-w-lg p-6 bg-white shadow-2xl rounded-2xl dark:bg-gray-900 dark:text-white/80">
//                                             {/* Header */}
