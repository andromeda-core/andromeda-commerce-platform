...
const index = ({ privacy_policy }) => {
    ...
    const dynamicSections = useMemo(() => {
        return (
            privacy_policy?.content?.map((section) => ({
                    ...
                    <div className="relative overflow-hidden text-main-text-dark dark:text-main-text-light">
                        ...
                        <div className="relative mx-auto my-2 sm:max-w-3xl lg:max-w-6xl">
                            ...
                            <p className="dark:sub-text-dark mt-1 max-w-3xl text-sm text-sub-text-light">
                                {__(
                                    'This Policy explains how we collect, use, store, and protect your personal information when you use our services.',
                                )}
                            </p>
                                    ...
                                    <nav className="space-y-1">
                                        {sections.map((section) => (
                                            <button
                                                ...
                                                className={`group flex w-full items-center gap-3 rounded-md px-4 py-3 text-left text-sm font-medium transition-all ${
                        ...
                        <main className="flex-1 space-y-6">
                            ...
                            <section className="rounded-md bg-surface-1-light p-8 dark:bg-surface-1-dark dark:backdrop-blur-xl">
                                <p className="leading-relaxed text-sub-text-light dark:text-sub-text-dark">
                                    {__('This Privacy Policy explains how')}{' '}
                                    {privacy_policy?.company_name} (
                                    {__('“Company,” “we,” “us,” or “our”')}).{' '}
                                    {__(
                                        'collects, uses, stores, shares, and protects personal information in connection with the operation of our international e-commerce platform for mobile device sales (the “Service”).',
                                    )}
                                </p>

                                <p className="mt-2 leading-relaxed text-sub-text-light dark:text-sub-text-dark">
                                    {__(
                                        'This Privacy Policy is an integral part of, and must be read together with, our Terms of Service, Shipping Policy, and Return & Refund Policy.',
                                    )}
                                </p>
                            </section>
                            ...
                            <section
                                ...
                                className="scroll-mt-32 rounded-md bg-surface-1-light p-8 dark:bg-surface-1-dark dark:backdrop-blur-xl"
                            >
                                <div className="mb-6 flex items-center gap-4">
                                    <h2 className="text-xl font-semibold text-main-text-light dark:text-main-text-dark">
                                ...
                                <div>
                                    <p className="leading-relaxed text-sub-text-light dark:text-sub-text-dark">
                                        ...
                                        <Link
                                            ...
                                            className="font-semibold text-main-text-light hover:underline dark:text-main-text-dark"
                                        >
                                            {route('website.data-deletion.index')}
                                        </Link>
                                    </p>
                                    ...
                                    <p className="leading-relaxed text-sub-text-light dark:text-sub-text-dark">
                                        .{' '}
                                        {__(
                                            'Or contact us at privacy@andromeda.blue with subject line "Data Deletion Request"',
                                        )}
                                    </p>
                                </div>
                                ...
                                <div>
                                    <p className="leading-relaxed text-sub-text-light dark:text-sub-text-dark">
                                        {__(
                                            'Upon receiving a veriﬁed request, all Facebook Login data, order details, and delivery information will be permanently deleted, unless retention is required by law.',
                                        )}
                                    </p>
                                </div>
                                ...
                                <div className="pb-5">
                                    <p className="leading-relaxed text-sub-text-light dark:text-sub-text-dark">
                                        {__(
                                            'Users may revoke permissions from their Facebook account under Settings → Business Integrations to disconnect andromeda.blue.',
                                        )}
                                    </p>
                                </div>

                                {/* Company & Legal Information (Meta Verification) */}
                                <div className="mb-3 mt-4 flex items-center gap-4">
                                    <h2 className="text-lg font-semibold text-main-text-light dark:text-main-text-dark">
                                ...
                                <div className="pb-8">
                                    <p className="leading-relaxed text-sub-text-light dark:text-sub-text-dark">
                                        ...
                                        <strong>{privacy_policy?.company_name}</strong>
                                    </p>
