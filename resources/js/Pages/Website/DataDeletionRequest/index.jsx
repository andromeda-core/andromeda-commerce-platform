...
const DataDeletion = () => {
    ...
    const submit = async (e) => {
        ...
        const result = await confirm({
            title: __('Are You Sure You Want To Delete Your Data') + '?',
    ...
    return (
        <MainLayout>
            ...
            <div className="px-6 lg:my-5 lg:px-8">
                <div className={`mx-auto ${windowSize.width > 1024 ? 'pb-0' : 'pb-24'} lg:max-w-7xl sm:max-w-3xl`}>
                    ...
                    <div className="relative overflow-hidden ">
                        ...
                        <div className="relative max-w-3xl mx-auto my-2 lg:max-w-6xl ">
                    ...
                    {/* Main Content */}
                    <div className={`mx-auto  mt-10  sm:max-w-3xl lg:max-w-6xl`}>
                            ...
                            <div className="lg:col-span-2 lg:mb-5">
                                <form onSubmit={submit}>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div>
                                            <WebTextArea
                                                InputName={__('Reason For Deletion')}
                                                Id={'reason'}
                                                Name={'reason'}
                                                Error={errors.reason}
                                                Value={data.reason}
                                                ...
                                                Required={true}
                                                Rows={7}
                                                Placeholder={__('Enter Your Reason For Deletion')}
                                                ClassName={'dark:bg-surface-1-dark'}
                                            />
                                        </div>
