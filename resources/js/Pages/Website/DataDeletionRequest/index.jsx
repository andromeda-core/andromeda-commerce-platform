                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex gap-4 pt-4">
                                            <button
                                                ...
                                                type="submit"
                                                className={`flex-1 ${isDisabled && 'pointer-events-none cursor-not-allowed opacity-25 dark:opacity-40'} rounded-xl bg-gradient-to-r from-red-600 to-pink-600 px-6 py-4 font-semibold text-white shadow-lg transition-all hover:from-red-700 hover:to-pink-700 hover:shadow-xl dark:from-red-500 dark:to-pink-600`}
                                            >
