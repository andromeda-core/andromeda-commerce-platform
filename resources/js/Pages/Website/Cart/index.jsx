...
// NEW LOCAL CURRENCY DISPLAY LOGIC IMPLEMENTED BELOW JUST NEEDED CONFIRMATION TO PROCEED WITH IT
// import React, { useState } from 'react';
// import { Head, Link, router, usePage } from '@inertiajs/react';
// import MainLayout from '@/Layouts/Website/MainLayout';
// import Placeholder from 'asset/assets/images/product/placeholder.jpg';
...
//                     <div className="mb-4">
//                         <DisplayPrice
//                             usdAmount={item.unit_price}
//                             showEstimatedLabel={false}
//                             className="text-[16px] font-semibold text-main-text-light dark:text-main-text-dark"
//                         />
//                     </div>
...
// // Addon Item Component
// function AddonItem({ item, quantity, onUpdateQuantity, onRemove, removing, __ }) {
//     return (
...
//             {/* Total Price */}
//             <DisplayPrice
//                 usdAmount={item?.unit_price * quantity}
//                 showEstimatedLabel={false}
//                 className="w-16 text-right text-[14px] font-semibold text-main-text-light dark:text-main-text-dark lg:w-24 lg:flex-shrink-0"
//             />
//         </div>
//     );
// }
...
// // Order Summary Component
// function OrderSummary({ summary, cart_items, __ }) {
//     return (
//         <div className="sticky space-y-3">
//             {/* Summary Card */}
...
//                         usdAmount={summary.items_total}
//                         showEstimatedLabel={false}
//                         className="text-[28px] font-semibold text-main-text-light dark:text-main-text-dark"
//                     />
//                 </div>
