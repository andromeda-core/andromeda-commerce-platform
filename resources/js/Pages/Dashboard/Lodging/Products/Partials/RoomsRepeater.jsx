...
import { blankRoom, blankRatePlan, toOptions, bedTypeOptions, ToggleField } from './helpers';
...
export default function RoomsRepeater({ data, setData, errors, enums, amenities }) {
        ...
        <div className="mt-8">
            ...
            {rooms.map((room, index) => (
                ...
                >
                    ...
                    {/* Rate Plans (nested) */}
                    <div className="p-4 mt-6 rounded-lg bg-gray-50 dark:bg-white/5">
