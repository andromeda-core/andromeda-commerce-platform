...
export default function edit({ priceRange }) {
    const { props } = usePage();
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        is_active: priceRange?.is_active ? 1 : 0,
    });

    // Update Data Form Request
    const submit = (e) => {
        e.preventDefault();
        put(route('dashboard.settings.price-ranges.update', priceRange?.id));
    };
