...
export default function edit({ terms_of_service, languages }) {
    // Edit Data Form Data
    const { data, setData, put, processing, errors } = useForm({
        ...
        language_id: terms_of_service?.language_id || '',
        dpo_name: terms_of_service?.dpo_name || '',
        dpo_email: terms_of_service?.dpo_email || '',
        dpo_phone: terms_of_service?.dpo_phone || '',
        dpo_address: terms_of_service?.dpo_address || '',
        company_name: terms_of_service?.company_name || '',
        country: terms_of_service?.country || '',
        state: terms_of_service?.state || '',
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('dashboard.settings.terms-of-service-settings.update', terms_of_service?.id));
    };
    ...
    return (
        <>
            <AuthenticatedLayout>
                ...
                <BreadCrumb
                    header={'Settings - Edit Terms Of Service'}
