...
export default function edit({ privacy_policy, languages }) {
    // Edit Data Form Data
    const { data, setData, put, processing, errors } = useForm({
        ...
        dpo_name: privacy_policy?.dpo_name || '',
        dpo_email: privacy_policy?.dpo_email || '',
        dpo_phone: privacy_policy?.dpo_phone || '',
        dpo_address: privacy_policy?.dpo_address || '',
        company_name: privacy_policy?.company_name || '',
        country: privacy_policy?.country || '',
        state: privacy_policy?.state || '',
        language_id: privacy_policy?.language_id || '',
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('dashboard.settings.privacy-policy-settings.update', privacy_policy?.id));
    };

    return (
        <>
            <AuthenticatedLayout>
                <Head title="Settings - Privacy Policy Settings" />

                <BreadCrumb
                    header={'Settings - Edit Privacy Policy'}
                    parent={'Privacy Policy Settings'}
                    parent_link={route('dashboard.settings.privacy-policy-settings.index')}
                    child={'Privacy Policy Settings'}
                />
                                    ...
                                    Content={
                                        <>
                                            <div className="grid grid-cols-1 gap-4 mb-10 md:grid-cols-2">
                                                ...
                                                <SelectInput
                                                    InputName={'Privacy Policy Language'}
                                                    ...
                                                    Placeholder={'Select Privacy Policy Language'}
