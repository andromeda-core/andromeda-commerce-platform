...
export default function index({ privacy_policies }) {
    ...
    const toggleStatus = (id) => {
        put(route('dashboard.settings.privacy-policy-settings.toggle-status', id));
    };

    const [columns, setColumns] = useState([]);
    useEffect(() => {
        const columns = [
            { key: 'name', label: 'Privacy Policy Name' },
    ...
    return (
        <>
            <AuthenticatedLayout>
                ...
                <BreadCrumb
                    header={'Settings - Privacy Policy Settings'}
                    parent={'Settings'}
                        ...
                        <>
                            <div className="flex flex-wrap justify-end gap-4 my-3">
                                <LinkButton
                                    ...
                                    URL={route('dashboard.settings.privacy-policy-settings.create')}
                                    Icon={
                                        <svg
                            ...
                            <Table
                                ...
                                BulkDeleteRoute={
                                    'dashboard.settings.privacy-policy-settings.destroybyselection'
                                }
                                SingleDeleteRoute={
                                    'dashboard.settings.privacy-policy-settings.destroy'
                                }
                                EditRoute={'dashboard.settings.privacy-policy-settings.edit'}
                                SearchRoute={'dashboard.settings.privacy-policy-settings.index'}
                                Search={false}
                                DefaultSearchInput={false}
                                items={privacy_policies}
                                props={props}
                                columns={columns}
                            />
                        </>
