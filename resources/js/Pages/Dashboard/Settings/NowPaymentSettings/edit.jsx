...
export default function edit({ now_payment_setting }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('dashboard.settings.now-payment-settings.update', now_payment_setting?.id));
    };
                                ...
                                <Card
                                    Content={
                                        <>
                                            ...
                                            <PrimaryButton
                                                Text={'Update NOWPayment Setting'}
                                                Type={'submit'}
                                                CustomClass={'w-[300px] '}
                                                Disabled={
                                                    processing ||
