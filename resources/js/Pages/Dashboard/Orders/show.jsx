                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                                {order.final_attachments.map((attachment, index) => (
                                                    <div
                                                        key={index}
                                                        className="relative overflow-hidden transition-all bg-white border border-gray-200 shadow-sm group rounded-2xl hover:shadow-md dark:bg-deepcharcoal dark:border-gray-700"
                                                    >
                                                        {/* Preview */}
                                                        <div className="relative w-full p-4">
                                                            <div className="relative flex items-center justify-center h-40 overflow-hidden border rounded-xl bg-gray-50 dark:bg-zinc-900/40 dark:border-gray-700">
                                                                ...
                                                                {/* Hover Actions */}
                                                                <div className="absolute inset-0 items-center justify-center hidden gap-2 transition-opacity opacity-0 lg:flex bg-black/35 group-hover:opacity-100">
                                                                    {/* View */}
                                                                    <a
                                                                        href={attachment.url}
                                                                        target="_blank"
                                                                        rel="noreferrer"
                                                                        className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-white rounded-xl bg-white/15 hover:bg-white/25 backdrop-blur"
                                                                        title="View"
                                                                    >
                                                                    ...
                                                                    {/* Download */}
                                                                    <button
                                                                        onClick={() => handleFileDownload(attachment.name, attachment.url)}
                                                                        className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-white rounded-xl bg-white/15 hover:bg-white/25 backdrop-blur"
                                                                        title="Download"
                                                                    >
                                                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        <div className="px-4 pb-4">
                                                            <p className="text-sm font-semibold text-gray-900 truncate dark:text-white/90">
                                                                {attachment.name}
                                                            </p>
                                                            ...
                                                            {/* Always-visible actions (mobile friendly) */}
                                                            <div className="flex gap-2 mt-4 lg:hidden">
                                                                <a
                                                                    href={attachment.url}
                                                                    target="_blank"
                                                                    rel="noreferrer"
                                                                    className="inline-flex items-center justify-center flex-1 gap-2 px-3 py-2 text-sm font-medium text-blue-600 rounded-xl bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-900/50"
                                                                >
                                                                    View
                                                                </a>
                                                                <button
                                                                    onClick={() => handleFileDownload(attachment.name, attachment.url)}
                                                                    className="inline-flex items-center justify-center flex-1 gap-2 px-3 py-2 text-sm font-medium text-gray-700 rounded-xl bg-gray-50 hover:bg-gray-100 dark:bg-zinc-900/70 dark:text-white/70 dark:hover:bg-zinc-900/50"
                                                                >
                                                                    Download
                                                                </button>
                                                            </div>
