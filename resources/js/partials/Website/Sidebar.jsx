                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            <button
                                data-sidebar-link="true"
                                title={__('Currency')}
                                className={`flex w-full items-center gap-3 px-4 rounded-md py-2.5 text-md transition-colors ${activeModal === 'currency-switcher'
                                    ? 'menu-item-active'
                                    : 'menu-item-inactive'
                                    }`}
                                onClick={() => {
                            ...
                            >
                                {/* Dollar-circle icon */}
                                <svg xmlns="http://www.w3.org/2000/svg" className={`size-6 text-main-text-light dark:text-main-text-dark`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round">
