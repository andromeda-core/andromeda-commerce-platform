...
export default function Header({
    ...
    const [profileDesktopDropdown, setProfileDesktopDropdown] = useState(false);
    const [profileMobileDropdown, setProfileMobileDropdown] = useState(false);
    ...
    useEffect(() => {
        function handleClickOutside(event) {
            if (
                ...
                !profileDropdownRefDesktop.current.contains(event.target)
            ) {
                setProfileDesktopDropdown(false);
            }
            ...
            if (
                ...
                setProfileMobileDropdown(false);
            }
        }
            ...
            <header className="z-50 bg-white border-b border-gray-200 shadow-md dark:border-gray-700 dark:bg-gray-800">
                ...
                <div className="flex items-center justify-center space-x-4 text-sm font-medium">
                    <span className="hidden sm:inline">
                        📱 Latest iPhone 15 Pro Max now available
                    </span>
                    <span className="sm:hidden">iPhone 15 Pro Max available</span>
                    ...
                    <div className="flex items-center justify-end h-16">
                        ...
                        {/* <div className="flex items-center">
                            <nav className="hidden lg:ml-10 lg:flex lg:space-x-8">
                                ...
                                <a
                                    href="#"
                                    className="px-1 py-2 text-sm font-medium text-gray-700 transition-colors hover:text-blue-600 dark:text-white/80 dark:hover:text-white/60"
                                >
                                    Products
                                </a>
                                <a
                                    href="#"
                                    className="relative px-1 py-2 text-sm font-medium text-gray-700 transition-colors hover:text-blue-600 dark:text-white/80 dark:hover:text-white/60"
                                >
                                    Contact Us
                                </a>
                            </nav>
                        ...
                        <div className="flex items-center space-x-1">
                                ...
                                <>
                                    ...
                                    <div className="items-center hidden px-3 py-2 space-x-2 border border-yellow-200 rounded-lg bg-yellow-50 dark:border-gray-800 dark:bg-gray-900 sm:flex">
                                        ...
                                        <span className="text-sm font-semibold text-gray-700 dark:text-white/80">
                                            {formatNumber(auth?.user?.reward_points ?? 0)}
                                        </span>
                                        <span className="hidden text-xs text-gray-500 dark:text-white/80 lg:inline">
                                            points
                                        </span>
                                    </div>
                            ...
                            {auth?.user && (
                                <>
                                    ...
                                    {/* Profile Desktop Dropdowwn */}
                                    <div
                                        className="relative z-[1] hidden p-5 lg:block"
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <svg
                                                className={` ${profileDesktopDropdown && 'rotate-180'} stroke-gray-500 dark:stroke-gray-400`}
                                                width="18"
                                                height="20"
                                                viewBox="0 0 18 20"
                                                fill="none"
                ...
                <div className="absolute left-0 top-[4rem] z-[100] flex w-full flex-col gap-y-5 bg-white dark:bg-gray-800 sm:gap-y-5 md:gap-y-5 lg:hidden">
                    {auth?.user && (
                        <>
                            ...
                            <div
                                className="relative z-[100] mx-5 block lg:hidden"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <svg
                                        className={` ${profileMobileDropdown && 'rotate-180'} stroke-gray-500 dark:stroke-gray-400`}
                                        width="18"
                                        height="20"
                                        viewBox="0 0 18 20"
                                        fill="none"
                                    ...
                                    <div className="absolute left-10 mt-[10px] flex w-auto min-w-[250px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-2xl dark:border-gray-800 dark:bg-gray-900">
                                        <div>
                                            ...
                                            <span className="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">
                                                {auth?.user.email.length > 20
                                                    ? auth?.user.email.slice(0, 20) + '...'
                                                    : (auth?.user.email ?? 'info@gmail.com')}
                                            </span>
                                        </div>
