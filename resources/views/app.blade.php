...
<head>
    ...
    fbq('set', 'autoConfig', 'false', '{{ config('services.meta_pixel.id', '1707084700603221') }}');
    fbq('init', '{{ config('services.meta_pixel.id', '1707084700603221') }}');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id={{ config('services.meta_pixel.id', '1707084700603221') }}&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
    @endif
